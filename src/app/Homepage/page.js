  ...
  return (
    <>
      <div className='bg-bg-homepage bg-bgHome bg-no-repeat bg-cover'>
        <section className="bg-[#0C3853] w-full h-screen flex flex-col items-center md:hidden relative">
        ...
        <section className="relative py-10 px-4 md:px-8 lg:px-16 xl:px-20 bg-white hidden md:flex">
