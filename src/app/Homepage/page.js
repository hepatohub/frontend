            ...
            <div className=" xl:container flex flex-row gap-[200px]">
              <div className="sm:text-center sm:ml-3 w-400 h-208 ">
                <h1 className=" text-h1-color text-lg/[46px] font-extrabold py-10">
                  <span className="text-spam-color text-4xl font-extrabold">
                    {" "}
                    PORTAL HEPÁTICO
                  </span>{" "}
                  <br />
                  Cuidando do seu{" "}
                  <span className="text-spam-color font-extrabold">
                    Fígado
                  </span>{" "}
                  <br />
                ...
                <div className="max-w-96">
                  <p className="text-h1-color text-base">
                    Bem-vindo ao Projeto de Gestão de Saúde Hepática Nós nos
                    dedicamos a fornecer uma plataforma abrangente para auxiliar
                    pacientes com problemas hepáticos e profissionais da saúde
                    no acompanhamento e gerenciamento da saúde do fígado. Nosso
                    objetivo é oferecer informações detalhadas, recursos de
                    auto-cuidado, consulta de medicamentos e uma comunidade
                    colaborativa para uma abordagem integrada ao cuidado
                    hepático.
                  </p>
                </div>
