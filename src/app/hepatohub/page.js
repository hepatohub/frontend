  ...
  return (
    ...
    <Header/>
      ...
      <div className='
        ...
        sm: border-2 sm:border-zinc-400 sm:rounded-xl
        lg:border-none
      '>
        <div className='
            flex bg-hepatodivs rounded-[26px] items-center justify-center
            sm:max-w-full sm:h-[400px]
            lg:w-[597px] lg:h-[277px]
          '>
          <p className='
            text-center text-h1-color text-lg 
            sm:max-w-full sm:p-4
            lg:w-[534px]
          '>O sistema de consultas de medicamentos para doenças hepáticas HepatoHub, utilizando dados abertos do Ministério da Saúde, é uma ferramenta extremamente valiosa para profissionais de saúde, pacientes e cuidadores. A aplicação deve fornecer informações precisas e atualizadas sobre medicamentos específicos para o tratamento de doenças hepáticas, garantindo uma abordagem mais eficaz e segura.</p>
        </div>
        <Image src="/doctor.png" alt="imagem de um médico" width={398} height={398} className='sm:max-w-full'/>
      </div>
      ...
      <div className='
        ...
        lg:border-none
      '>
        <Image src="/prancheta.png" alt="imagem de um médico" width={187} height={121} className='sm:max-w-full'/>
        <div className='
          flex bg-hepatodivs rounded-[26px] items-center justify-center
          sm:max-w-full
          lg:w-[597px] lg:h-[277px]
