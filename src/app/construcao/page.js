  ...
  >
    ...
    ">
      ...
      <div className="mt-7 flex flex-col items-center">
        <p className='text-roxo text-center text-xl font-semibold lg:w-[685px] sm:max-w-full'>Página não encontrada. Desculpe pelo transtorno. Se precisar de ajuda, entre em contato conosco.</p>
      </div>
